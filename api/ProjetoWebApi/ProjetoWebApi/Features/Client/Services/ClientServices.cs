...
namespace ProjetoWebApi.Features.Client.Services
{
    public class ClientServices : IClientServices
    {
        ...
        public async Task<List<ClientShowDto>> ClientsList(Guid IdAdmin, PaginationDto paginationDto)
        {
            ...
            var convertingClient = clienstList.Skip(paginationDto.pageSize * paginationDto.pageNumber).Take(paginationDto.pageSize).ToList();
            return ClientsShowMapping.ToClientShow(convertingClient);
        }
